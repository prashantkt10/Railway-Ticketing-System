    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img src="images/1.jpg" alt="Chania" style="height: 460px; width: 1000px">
          <div class="carousel-caption">
            <h3>Old Trains</h3>
            <p>Serving since years...</p>
          </div>
        </div>

        <div class="item">
          <img src="images/2.jpg" alt="Chania" style="height: 460px; width: 1000px">
          <div class="carousel-caption">
            <h3>Present Trains</h3>
            <p>Still serving people, providing comfort and safe journey.</p>
          </div>
        </div>

        <div class="item">
          <img src="images/3.jpg" alt="Flower" style="height: 460px; width: 1000px">
          <div class="carousel-caption">
            <h3>Future Trains</h3>
            <p>Using technologies looking forward to provide much better journey to people.</p>
          </div>
        </div>

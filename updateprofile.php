...
if (isset($_POST['update'])) {
	...
	$sq=$_POST['sq'];
	$sa=$_POST['sa'];
	$query="UPDATE `users` set fullname='$fname', mobile='$nmobile', address='$address', sq='$sq', sa='$sa' where username='$user'";
  ...
  <form action="" method="post">
    ...
    <div class="well">
    	<div class="form-group">
    		...
    		<input type="text" class="form-control" style="width:300px" readonly="" value="<?php echo $user ?>">
    	</div>
    	<div class="form-group">
    		<label for="" class="control-label">Birthdate:</label>
    		<input type="text" class="form-control" style="width:300px" readonly="" value="<?php echo $birth ?>">
    	</div>
    	<div class="form-group">
    		<label for="" class="control-label">First Name:</label>
    		<input type="text" name="fname" class="form-control" style="width:300px" value="<?php echo $name ?>" required="">
    	</div>
    	<div class="form-group">
    		<label for="" class="control-label">Mobile:</label>
    		<input type="text" maxlength="10" name="nmobile" class="form-control" value="<?php echo $newmobile ?>" style="width:300px" required="">
    	</div>
    	</div>
    	</div>
    	...
    	<div class="form-group">
    		...
    		<textarea class="form-control" rows="5" name="address" style="width: 290px"><?php echo $address ?></textarea>
    	</div>
    	<div class="form-group">
      ...
      <div class="form-group">
  		...
  		<input type="text" class="form-control" required="" value="<?php echo $answer ?>" id="answer" placeholder="answer here" style="width: 290px" name="sa" required>
	</div>
	</div>
  </div>
  <div class="col-md-1">
  	<div class="form-group" style="margin-top: 110px">
  		<input type="submit" class="btn btn-success" name="update" value="Update" style="width: 80px; height: 50px">
  	</div>
  	<div class="form-group" style="margin-top: 30px">
  		<input type="reset" class="btn btn-warning" value="Clear" style="width: 80px; height: 50px">
  	</div>
  </div>
  </form>
</div>

...
if (isset($_POST['update'])) {
	...
	if ($pass1==$pass2) {
		...
		$query="UPDATE users set password='$pass1' where username='$userid'";
...
<div class="col-md-9">
    ...
    <form action="" method="post" style="margin-left:370px">
      <div class="form-group">
        <h3 class="lead"><u>Change Password</u></h3>
      </div>
      <div class="form-group">
      <label for="" class="control-label">Enter password</label>
        <input type="password" name="pass1" class="form-control" style="width: 150px" required>
      </div>
      <div class="form-group">
      <label for="" class="control-label">Confirm password</label>
        <input type="password" name="pass2" class="form-control" style="width: 150px" required>
      </div>
      <div class="form-group">
        <input type="submit" name="update" class="btn btn-success" value="Change" style="margin-left:30px">
      </div>
    </form>
    </div>
  </div>
